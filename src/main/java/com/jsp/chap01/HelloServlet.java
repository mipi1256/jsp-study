...
public class HelloServlet extends HttpServlet { // HttpServLet을 상속받습니다.
   ...
   // 가본 생성자
   public HelloServlet() {
      // 요정이 들오면 서블릿 객체가 서버 내에서 자동 생성됩니다.
      System.out.println("\n\n\n Hello 서블릿 작동 시작! \n\n\n");
   }
   ...
   protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      // 매개값으로 요청에 대한 정보가 담신 HttpServLetRequest와
      ...
      response.setCharacterEncoding("UTF-8"); // For multiple language encoding

      // HTML 문서를 작성할 writer 객채를 생성.
      PrintWriter w = response.getWriter();
      // w.write(); you write all the things you want to add to the HTML using this code
