...
<%--
    // Dispatcher에 의해 request 객체가 이쪽으로 전달 됐을 것입니다.
...
<body>
    ...
    <ul id="dancer-list">
        ...
        <%--
            c:forEach 태그를 이용하여 항살 for문을 구현하는 법.
            제어변수를 선언하시고, items 속성에 반복문을 돌리고자 하는 컬켁션 자료형을 세팅.
    ...
    <script>
        ...
        $dancerList.onclick = e => {
            ...
            // 서버에 링크로 삭제 요청 -> 원칙적으로 링크로 삭지 요청하면 안됩니다.
            // 링크로 삭제 요청하면 get 요청이 들어감 -> 삭제는 post로 전달해야 합니다.
            // 자바스크립트로 form 없이 post요청 보내는 방법은 추후에 알려드립니다.
